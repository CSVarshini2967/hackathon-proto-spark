          ...
          <Card className="lg:col-span-2">
            ...
            <CardContent>
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between p-4 bg-muted/20 rounded-lg">
                  <div>
                    <h4 className="font-semibold">Evening Snack (4:00 PM)</h4>
                    <p className="text-sm text-muted-foreground">Warm milk with turmeric</p>
                    <p className="text-xs text-muted-foreground">Pending - 180 calories</p>
                  </div>
                  <div className="text-right">
                    <span className="text-sm font-medium">Sweet, Warm</span>
                    <p className="text-xs text-muted-foreground">Calming</p>
                  </div>
                </div>

                <div className="flex items-center justify-between p-4 bg-muted/20 rounded-lg">
                  <div>
                    <h4 className="font-semibold">Dinner (7:30 PM)</h4>
                    <p className="text-sm text-muted-foreground">Lentil soup with steamed rice</p>
                    <p className="text-xs text-muted-foreground">Pending - 520 calories</p>
                  </div>
                  <div className="text-right">
                    <span className="text-sm font-medium">Sweet, Warm</span>
                    <p className="text-xs text-muted-foreground">Easy to digest</p>
                  </div>
                </div>
              </div>
            </CardContent>
              ...
              <CardContent>
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="w-full bg-muted rounded-full h-2">
                      <div className="bg-ayur-vata h-2 rounded-full" style={{ width: '70%' }}></div>
                    </div>
                  </div>
                  <div>
                    <div className="flex justify-between text-sm mb-1">
                    ...
                    <div className="w-full bg-muted rounded-full h-2">
                      <div className="bg-ayur-kapha h-2 rounded-full" style={{ width: '90%' }}></div>
                    </div>
                  </div>
                </div>
              </CardContent>
              ...
              <CardContent>
                <div className="space-y-3">
                  ...
                  <div className="flex items-center justify-between p-3 bg-muted/20 rounded-lg">
                    ...
                    <span className="text-xs text-muted-foreground">⏰ 8:30 PM</span>
                  </div>
                </div>
              </CardContent>
            </Card>
